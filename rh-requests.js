...
async function loadRequests(){
  const {data,error}=await db.from('disciplinary_requests').select('*,penalty_reasons(*),operations(cost_center,department)').order('created_at',{ascending:false})
